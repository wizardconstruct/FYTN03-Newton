...
//                }
                ...
                Params params = new Params();
                BufferedWriter w = new BufferedWriter(new FileWriter("hscaling.dat"));
    	for (double h = 0.5; h > 1e-8; h *= .5) {
			Simulation sim_resist = new Simulation(true, true, params.phi, params.v, h);				// Simulate with B1 and B2
